...
extern "C" {
    ...
    //void CS_UpdateNoticeShowPopup(const char* serverId, UpdateNoticePopupCB cb);		// added in ActiveUser iOS(2.6.6) & Android(2.6.6)
    // 2.7.2 - serverId 제거
    void CS_UpdateNoticeShowPopup(UpdateNoticePopupCB cb);
    
    // 공지팝업 정보
    //void CS_UpdateNoticeGetPopupInfo(const char*serverId, UpdateNoticeInfoCB cb);		// added in ActiveUser iOS(2.6.5) & Android(2.6.6)
    // 2.7.2 - serverId 제거
